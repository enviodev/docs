...
export default function ShowcaseDetail({ site }) {
  ...
  // Static social card generated by scripts/generate-showcase-og-images.js.
  // Used for og:image / twitter:image so every entry unfurls with its own card,
  // including video-only entries that have no static screenshot to share.
  const ogImage = `/img/showcase/og/${site.slug}.png`;
