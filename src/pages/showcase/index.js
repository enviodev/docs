...
// Generated by scripts/generate-showcase-og-images.js.
const OG_IMAGE = "img/showcase/og/_index.png";
...
export default function Showcase() {
  ...
  // Absolute, because several platforms drop a relative og:image.
  const ogImage = `${siteConfig.url}${siteConfig.baseUrl}${OG_IMAGE}`;
