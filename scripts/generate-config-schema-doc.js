...
/*
 ...
 - Input: static/schemas/config.evm.json (the published V2 schema)
 - Output: docs/HyperIndexV2/Advanced/config-schema-reference.md

 The V3 reference at docs/HyperIndex/Advanced/config-schema-reference.md is
 hand-authored against the V3 config shape (chains, rpc, max_reorg_depth,
 storage, ...) and is not regenerated by this script. Update it manually
 when the V3 config surface changes; once a public V3 JSON schema is
 available, repoint this script there.
*/
