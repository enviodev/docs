...
To upgrade an existing project, follow the [Migrate to V3](https://docs.envio.dev/docs/HyperIndex/migrate-to-v3) guide. For the complete rundown, see [What's New in V3](https://docs.envio.dev/docs/HyperIndex/whats-new-in-v3).
...
Original post on X: [https://x.com/katana/status/2056389958303441051](https://x.com/katana/status/2056389958303441051)
...
<blockquote class="twitter-tweet" data-media-max-width="560"><p lang="en" dir="ltr">Catch Denham on Monad&#39;s Devrel Livestream: HyperIndex on Monad, Monskills, and how to vibecode your way to a production indexer.</p>&mdash; Watch on X <a href="https://x.com/i/broadcasts/1qxvvkjpedaxB">x.com/i/broadcasts/1qxvvkjpedaxB</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

Missed it live? Catch the full recording on [X](https://x.com/i/broadcasts/1qxvvkjpedaxB).
...
▶ [Open Spotify](https://open.spotify.com/playlist/3XgXvqbIgrCTLzxqJRehxC?si=5d1949361dfb49a4)
