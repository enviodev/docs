...
_Note: Current Release is v2.26.0_
...
Love what we're building as much as we do and want to stay updated on our latest releases and developments? Give us a star on [GitHub](https://github.com/enviodev/hyperindex)!
...
We run these every last Thursday of the month, so keep an eye out for more builds.
...
We're proud to be building alongside some of the sharpest devs and innovators in the space. Huge thanks to everyone who made it happen.

Missed our workshop on lightning-fast multichain indexing? Catch the replay on [YouTube](https://www.youtube.com/watch?v=-sFCbIVVeRw&list=PLXzKMXK2aHh6jZYPY5-YIBzvMtUT3ajjI).
