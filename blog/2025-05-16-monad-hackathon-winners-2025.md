...
tags: ["announcements"]
description: "Winning projects from the Monad Envio Hackathon where developers built high-performance apps and showcased real-time blockchain data indexing on Monad."
...
[Gorillionaire](https://www.gorillionai.re/) is an AI-powered crypto trading platform delivering real-time Buy/Sell signals by analyzing onchain data, whale activity, token listings, and price feeds. It uses Envio to index data on Monad, giving users and bots fast access to high-signal, real-time insights.
...
Backed by Monad's performance and Envio's real-time indexing infrastructure, Gorillionaire shows what's possible when AI meets production-grade indexing built for scale.
...
We're looking forward to seeing these projects grow and to the next hackathon.
