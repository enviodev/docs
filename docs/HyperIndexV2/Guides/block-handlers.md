...
:::note
Block Handlers require [Preload Optimization](/docs/v2/HyperIndex/preload-optimization) to be enabled. Make sure to enable it in your `config.yaml` file. And don't forget that it makes your handlers run twice.
:::
...
- `block` - The block object.
  ...
  - More fields will be added in the future. Let us know in [Discord](https://discord.gg/envio) if you need any specific fields. You can also use [Effect API](/docs/v2/HyperIndex/effect-api) to get the data from RPC.
- `context` - Exactly the same as the Event Handlers [Context Object](/docs/v2/HyperIndex/event-handlers#context-object).
...
- Block Handlers require [Preload Optimization](/docs/v2/HyperIndex/preload-optimization) to be enabled.
- The [Ordered Multichain mode](/docs/v2/HyperIndex/multichain-indexing#ordered-mode) is not supported.
- Only EVM chains are supported. Currently no support for [Fuel](/docs/v2/HyperIndex/fuel) chains.
- No [test framework](/docs/v2/HyperIndex/testing) support.
