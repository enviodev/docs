...
3. Learn about [Preload Optimisation](/docs/v2/HyperIndex/preload-optimization) and how it makes your indexer thousands of times faster
4. Use [Effect API](/docs/v2/HyperIndex/effect-api) with built-in caching and Viem transport level batching
...
**Important!** Preload optimization makes your handlers run **twice**. So instead of direct RPC calls, we're doing it through `context.effect` - the [Effect API](/docs/v2/HyperIndex/effect-api).
...
> **Note:** Read more about Effect API and caching in the [Effect API](/docs/v2/HyperIndex/effect-api) guide.
