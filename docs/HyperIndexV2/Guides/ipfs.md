...
**Important!** Preload optimization makes your handlers run **twice**. So instead of direct RPC calls, we're doing it through the [Effect API](/docs/v2/HyperIndex/effect-api).

Learn how Preload Optimization works in a [dedicated guide](/docs/v2/HyperIndex/preload-optimization). It might be a new mental model for you, but this is what can make indexing thousands of times faster.
...
Follow the [Effect API Persistence](/docs/v2/HyperIndex/effect-api#persistence) guide to implement caching for local development. This should allow you to avoid repeatedly fetching the same data.
...
Learn how Preload Optimization works and the [Double-Run Footgun](/docs/v2/HyperIndex/preload-optimization#double-run-footgun) in a [dedicated guide](/docs/v2/HyperIndex/preload-optimization). It might be a new mental model for you, but this is what can make indexing thousands of times faster.
