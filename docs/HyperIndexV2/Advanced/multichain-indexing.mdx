...
For a comprehensive, production-ready example of multichain indexing, we recommend exploring our [Uniswap V4 Multichain Indexer](/docs/v2/HyperIndex/example-uniswap-v4-multi-chain-indexer). This official reference implementation:
...
- Explore our [Uniswap V4 Multichain Indexer](/docs/v2/HyperIndex/example-uniswap-v4-multi-chain-indexer) for a complete implementation
- Review [performance optimization techniques](/docs/v2/HyperIndex/performance) for your indexer
