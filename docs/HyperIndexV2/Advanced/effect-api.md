...
The Effect API provides a powerful and convenient way to perform external calls from your handlers. It's especially effective when used with [Preload Optimization](/docs/v2/HyperIndex/preload-optimization):
...
For detailed instructions, see the [Effect API Cache documentation](/docs/v2/HyperIndex/hosted-service-features#effect-api-cache).
