...
:::warning
Loaders are a predecessor of [Preload Optimization](/docs/v2/HyperIndex/preload-optimization). We recommend using [Preload Optimization](/docs/v2/HyperIndex/preload-optimization) instead of loaders. This guide is kept for historical purposes.
:::
...
They worked by implementing the [Preload Optimization](/docs/v2/HyperIndex/preload-optimization) - loading required data upfront before processing events.
...
Compared to the current [Preload Optimization](/docs/v2/HyperIndex/preload-optimization) approach, handlers with loaders didn't have the Preload Phase, and always ran once.
...
Find more information about how Loaders work by reading the [Preload Optimization - How It Works?](/docs/v2/HyperIndex/preload-optimization#how-it-works) guide. Loaders share the same concept, but with a different API.
