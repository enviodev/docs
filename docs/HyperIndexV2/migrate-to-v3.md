...
2. **If you were using loaders**, migrate them to Preload Optimization following the [Migrating from Loaders](/docs/v2/HyperIndex/preload-optimization#migrating-from-loaders) guide.
...
- [ ] Migrate from loaders if applicable ([guide](/docs/v2/HyperIndex/preload-optimization#migrating-from-loaders))
