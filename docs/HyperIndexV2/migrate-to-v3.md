...
3. If you were using loaders, migrate them to Preload Optimization following the [Migrating from Loaders](/docs/v2/HyperIndex/preload-optimization#migrating-from-loaders) guide.
