...
description: "A complete, combined version of Envio’s HyperSync documentation in one file. This includes the HyperSync overview, performance benchmarks, query system, client libraries, usage guides, curl examples, presets, supported networks, decoding, best practices, and advanced concepts — all consolidated specifically for LLMs and programmatic tools to read."
