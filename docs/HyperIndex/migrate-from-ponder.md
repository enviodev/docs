...
For an agent-friendly workflow, see [Developing with AI](./developing-with-ai)—non-interactive CLI, codegen and testing loops, plus optional migration prompts you can adapt for Ponder → HyperIndex.
:::
