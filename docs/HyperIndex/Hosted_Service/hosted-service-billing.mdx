...
- Effect API cache support for faster re-indexing
- Monitoring, alerts, and deployment management
- Priority support (Dedicated plan)

**How to switch plans:**
You can upgrade or downgrade your plan at any time from the **Settings > Plans & Billing** tab in your indexer's dashboard on [Envio Cloud](https://envio.dev/app).
