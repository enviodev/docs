...
- Works with any entity field. Since v3.5, HyperIndex creates whatever database index the query needs, so you don't have to declare [`@index`](/docs/HyperIndex/database-performance-optimization#indices-created-on-demand) for it.
