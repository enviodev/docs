...
To avoid this, you can use [Loaders](/docs/HyperIndex/loaders) together with [Effect API](/docs/HyperIndex/loaders) to parallelize external calls and make the indexing process more efficient.
...
Read more about the [Effect API](/docs/HyperIndex/loaders) and [Loaders](/docs/HyperIndex/loaders) in the dedicated guides.
