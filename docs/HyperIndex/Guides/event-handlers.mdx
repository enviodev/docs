...
Since v3.4, you can register as many handlers as you like for the same event, each with its own [`where`](/docs/HyperIndex/wildcard-indexing) filter. Earlier versions only accepted handlers whose filters matched.
