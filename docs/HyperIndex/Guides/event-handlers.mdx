...
:::note
For performance concerns related to `get` function calls in your handlers, refer to the [Benchmarking](/benchmarking) and [Loaders](/loaders) guides. These resources provide insights and solutions for optimizing performance.
:::
