...
:::note
Wildcard Indexing is supported on [HyperSync](/docs/HyperIndex/Advanced/hypersync.md), [HyperFuel](/docs/HyperIndex/fuel/fuel.md), and [RPC](/docs/HyperIndex/Advanced/rpc-sync.md) data sources. Since v3.3, an RPC-backed indexer can register **multiple** wildcard events — earlier versions allowed only one.
:::
...
:::note
`OR` filtering on [RPC data sources](/docs/HyperIndex/rpc-sync) requires v3.3 or later. On earlier versions the array form was only honoured by HyperSync.
:::
