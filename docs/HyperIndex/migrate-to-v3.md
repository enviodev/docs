...
A per-chain `block_lag` option to index behind the chain head by a specified number of blocks. Defaults to 0. This is for advanced use cases — only use it if you know what you're doing.
