...
Migrating Alchemy subgraphs to Envio’s HyperIndex is straightforward. Alchemy subgraphs follow The Graph’s model, and HyperIndex uses a very similar structure — so most of your existing setup carries over cleanly.

If you’re new to HyperIndex, we recommend starting with our [Getting Started](https://docs.envio.dev/docs/HyperIndex/getting-started) guide before beginning the migration.
