...
**Note**: that if no `required_entities` are set, then all entities can be used in your loader, but if it is set only entities in your required_entities can be used.

### labels and arrayLabels

To make your code more robust and explicit you can use the advanced [here](./labels) features.
