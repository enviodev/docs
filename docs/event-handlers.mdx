...
- `contracts` - An array of contract data

### contracts

- `config.contracts[0].name` - Name of the contract
- `config.contracts[0].abi` - ABI of the contract
- `config.contracts[0].addresses` - An array of addresses of the contract
- `config.contracts[0].events` - An array of event names emitted by the contract
