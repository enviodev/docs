...
### Loading an array of an entity

If you wish to load an array of an entity, then `arrayLabels` should be used in the `config.yaml` file, here is an [here](./array-label).
