...
since there may be unexpected repercussions when a deleted entity is linked to another entity. See [here](/linked-entity-loaders) for more information regarding linked entities
