...
**File:** `Advanced/performance/historical-sync.md`
...
**File:** `Advanced/performance/index.md`
...
**File:** `Advanced/persisted_files.md`
...
**File:** `Examples/example-example-cross-chain-messaging.md`
...
The ORMP Indexer showcases advanced multi-chain indexing techniques for tracking cross-chain communication. It offers a practical example of how to:
...
**File:** `Examples/example-liquidation-metrics.md`
...
**File:** `Guides/running-locally.md`
...
Once you have successfully run the indexer locally, you can deploy the indexer onto Envio's hosted service.
