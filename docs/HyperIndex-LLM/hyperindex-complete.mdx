...
1. **Ensure you've generated testing code**: Always run codegen after updating your schema or config

   ```bash
   pnpm codegen
   ```

2. **Check your imports**: Make sure you're importing the correct files
